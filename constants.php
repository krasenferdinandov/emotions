<?php
	...
	define ("CHOOSE_EMOTIONS", '<b><center><a title="Most common feelings means that you have to choose the most frequent feelings which happen again and again despite the circumstances. You can select them from all 90 words grouped in 10 categories."> Choose THE MOST COMMON expirienced feelings (e.g. for the last month) from all 10 groups shown below.</b><center/><br/></a>');
	...
	define ("NOT_ENOUGH_OR_TOO_MANY", '<center><a title="It means that you have not chosen the exact number of states. Please, go back and choose at least 2.">Choose at least 1 emotional state.</center></a>');	
