<?php
	...
	define ("CONTRIBUTION", '<p class="desc-res3" align="right"><a title="All members of programming team have right to change the code in order to improve or contribute to further development of testing model only with agreement of the author."><b>PHP, MySQL & JS programming: Hristo Venev, Hristo Minkov, Kristian Cuklev, Alex Tsvetanov, Dimo Chanev, Anton Denev, Valyo Yolovski and .</p><small>GPL v.3 Copyrights &copy; 2015 Krasen Ferdinandov, psychologist.</b></small></a>');	
	...
	define ("TIP3", '<p class="desc-res3" align="right">If you want to check your results, copy this adress:<br><center><b> www.testrain.info/finalbg.php?id=</b>');
