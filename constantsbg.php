<?php
	...
	define ("CHOOSE_STATIS", '<b><a title="Тези изречения ще послужат за оценка на пропорциите между представените в теста психологически ситуации, които да пресъздадат реалната ти представата за емоционално отношение.">Отбележи тези квадратчета пред изреченията, които описват НАЙ-ТОЧНО твоето емоционално поведение.</b></a>');
