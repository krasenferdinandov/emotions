<?php
require "header.php";
echo '<form method="POST" id="the_form" action="insrt.php" enctype="multipart/form-data" onSubmit="return checkboxesOkay(this);">';
...
if(isset($_POST['choice'])){
	if($_POST['choice'] == '1') {
		...
		echo '<td><br><a title="'.quot($bg_name).'"><label for="checkit'.$id.'">'.$en_name.'</a></label></td></tr>';
		}
		echo '<input type="hidden" value="1" name="choice"/>';
		echo $table;
		}
