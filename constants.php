<?php
	...
	define ("CONTRIBUTION", '<p class="desc-res3" align="right"><a title="All members of programming team have right to change the code in order to improve or contribute to further development of testing model only with agreement of the author."><b>PHP & JS programming: Hristo Venev, Hristo Minkov, Anton Denev, Valyo Yolovski, Alex Tsvetanov, Dimo Chanev and Kristian Cuklev.</p><small>GPL v.3 Copyrights &copy; 2015 Krasen Ferdinandov, psychologist.</b></small></a>');	
